...
model_path = './student/'
num_classes = 2
num_train_samples =88678
num_valid_samples =11084
verbose = 1
batch_size = 4
num_epochs = 50
patience = 50
...
trained_models_path = model_path + g + '/model_'


base_model = efn.EfficientNetB0(input_shape=( 224,224,3), weights='imagenet', include_top=False)
#base_model = efn.EfficientNetB0(input_shape=( 224,224,3), weights='noisy-student', include_top=False)
