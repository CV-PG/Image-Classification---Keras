...
#base_model = EfficientNetB5(input_shape=( 456,456,3), weights='imagenet', include_top=False)
base_model = efn.EfficientNetB5(input_shape=( 456,456,3), weights='noisy-student', include_top=False)
