...
num_classes = 3
num_train_samples =1285
num_valid_samples =159
verbose = 1
batch_size = 4
num_epochs = 50
patience = 50
...
#base_model = EfficientNetB7(input_shape=( 600,600,3), weights='imagenet', include_top=False)
base_model = efn.EfficientNetB7(input_shape=( 600,600,3), weights='noisy-student', include_top=False)
...
x = keras.layers.AveragePooling2D((15,15))(base_model.output)
