...
base_model = SEResNet50(input_shape=(224,224,3), weights='imagenet', include_top=False)
...
model_names = trained_models_path + '.{epoch:02d}-{val_acc:.2f}_2class_' + model_name + '.hdf5'
